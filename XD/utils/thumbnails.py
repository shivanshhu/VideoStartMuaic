...
async def gen_thumb(videoid, user_id):
    ...
    try:
        ...
        bg = Image.open(f"XD/assets/XD.png")
        ...
        font = ImageFont.truetype("XD/assets/font2.ttf", 45)
        ImageFont.truetype("XD/assets/font2.ttf", 70)
        arial = ImageFont.truetype("XD/assets/font2.ttf", 30)
        ImageFont.truetype("XD/assets/font.ttf", 30)
